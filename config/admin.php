...
return [
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => Igorhaf\Admin\Auth\Database\Administrator::class,
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => Igorhaf\Admin\Auth\Database\Administrator::class,

        // Role table and model.
        'roles_table' => 'admin_roles',
        'roles_model' => Igorhaf\Admin\Auth\Database\Role::class,

        // Permission table and model.
        'permissions_table' => 'admin_permissions',
        'permissions_model' => Igorhaf\Admin\Auth\Database\Permission::class,

        // Menu table and model.
        'menu_table' => 'admin_menu',
        'menu_model' => Igorhaf\Admin\Auth\Database\Menu::class,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'grid_action_class' => \Igorhaf\Admin\Grid\Displayers\DropdownActions::class,
