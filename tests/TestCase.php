...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Igorhaf\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Igorhaf\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Igorhaf\Admin\AdminServiceProvider']);
...
//        \Igorhaf\Admin\Admin::$css = [];
//        \Igorhaf\Admin\Admin::$js = [];
//        \Igorhaf\Admin\Admin::$script = [];
    }
