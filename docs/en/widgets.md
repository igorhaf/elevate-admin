...
Refer to the section on the `InfoBox` in the `index()` method of the home page layout file [HomeController.php](https://github.com/z-song/elevate-admin/blob/master/src/Console/stubs/HomeController.stub).
