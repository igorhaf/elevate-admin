...
`Igorhaf\Admin\Widgets\Box` used to generate box components:

```php
use Igorhaf\Admin\Widgets\Box;
...
`Igorhaf\Admin\Widgets\Collapse` class used to generate folding components:
```php
use Igorhaf\Admin\Widgets\Collapse;
...
`Igorhaf\Admin\Widgets\Form` class is used to quickly build a form:
...
`Igorhaf\Admin\Widgets\InfoBox` class is used to generate the information presentation block:

```php
use Igorhaf\Admin\Widgets\InfoBox;
...
Refer to the section on the `InfoBox` in the `index()` method of the home page layout file [HomeController.php](https://github.com/igorhaf/elevate-admin/blob/master/src/Console/stubs/HomeController.stub).

## Tab component

`Igorhaf\Admin\Widgets\Tab` class is used to generate the tab components:

```php
use Igorhaf\Admin\Widgets\Tab;
...
`Igorhaf\Admin\Widgets\Table` class is used to generate tables:

```php
use Igorhaf\Admin\Widgets\Table;
