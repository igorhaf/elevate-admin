...
The layout usage of `elevate-admin` can be found in the `index()` method of the home page's layout file [HomeController.php](https://github.com/igorhaf/elevate-admin/blob/master/src/Console/stubs/HomeController.stub).
