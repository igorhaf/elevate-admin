...
>Static resources in the class can also be imported from outside, see [Editor.php](https://github.com/igorhaf/elevate-admin/blob/1.3/src/Form/Field/Editor.php)
