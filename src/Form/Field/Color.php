...
class Color extends Text
{
    protected static $css = [
        '/vendor/elevate-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.css',
    ];

    protected static $js = [
        '/vendor/elevate-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.js',
    ];
