...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/vendor/elevate-admin/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css',
    ];

    protected static $js = [
        '/vendor/elevate-admin/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js',
    ];
