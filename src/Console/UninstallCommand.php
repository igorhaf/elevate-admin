...
class UninstallCommand extends Command
{
    ...
    {
        if (!$this->confirm('Are you sure to uninstall elevate-admin?')) {
            return;
        }

        $this->removeFilesAndDirectories();

        $this->line('<info>Uninstalling elevate-admin!</info>');
    }
    ...
    protected function removeFilesAndDirectories()
    {
        ...
        $this->laravel['files']->deleteDirectory(public_path('vendor/elevate-admin/'));
