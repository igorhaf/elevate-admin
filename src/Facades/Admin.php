...
namespace Igorhaf\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \Igorhaf\Admin\Grid grid($model, \Closure $callable)
 * @method static \Igorhaf\Admin\Form form($model, \Closure $callable)
 * @method static \Igorhaf\Admin\Show show($model, $callable = null)
 * @method static \Igorhaf\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \Igorhaf\Admin\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \Igorhaf\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \Igorhaf\Admin\Admin::class;
    }
}
